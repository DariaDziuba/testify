        ...
        <SafeAreaView className="flex-1">
            ...
            >
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <ScrollView className="m-3 p-1  rounded-md border-2 border-gray-200">
                        <View>
                        ...
                        <View>
                            ...
                            <View className="flex-row justify-center">
                                <Text className="text-center text-sky-500 font-bold">Вже є акаунт? </Text>
                                <Text className="text-center text-sky-500 font-bold underline">Вхід</Text>
                            </View>
                            </TouchableOpacity>
                        </View>
                    </ScrollView>
