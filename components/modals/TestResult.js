...
const TestResult = ({visible, hideModal, testID}) => {
                ...
                <View className="bg-white w-4/5 rounded-md p-3">
                    ...
                    <View className="p-2 pr-4">
                        <View className="flex-row items-center w-5/6 mb-3">
                            <Ionicons name="checkmark" size={30} color="#0ea5e9"/>
                            <Text className="text-gray-800 mb-1 ml-2 text-base leading-4">
                                Проходження тесту {testID} завершено. Ваш результат <Text className="underline">збережено</Text>.
                            </Text>
                        </View>
                    </View>
